void taskCNC(void * parameter) {
    ...
    if (configManager && configManager->isConfigLoaded()) {
        ...
        state.X.maxFeedRate = config.xAxis.workFeedRate;       // Poprawiono nazwę pola
        state.X.maxAcceleration = config.xAxis.workAcceleration; // Poprawiono nazwę pola
        ...
        state.Y.maxFeedRate = config.yAxis.workFeedRate;       // Poprawiono nazwę pola
        state.Y.maxAcceleration = config.yAxis.workAcceleration; // Poprawiono nazwę pola
