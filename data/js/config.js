  ...
  fetch('/api/config')
    ...
    .then(config => {
      if (config.xAxis) {
        ...
        document.getElementById('xWorkFeedRate').value = config.xAxis.workFeedRate;
        document.getElementById('xWorkAcceleration').value = config.xAxis.workAcceleration;
      ...
      if (config.yAxis) {
        ...
        document.getElementById('yWorkFeedRate').value = config.yAxis.workFeedRate;
        document.getElementById('yWorkAcceleration').value = config.yAxis.workAcceleration;
...
function saveConfiguration(event) {
  ...
  .then(data => {
    ...
    else showMessage('Failed to save configuration: ' + (data.message || 'Unknown error'), 'error');
  })
  .catch(error => {
